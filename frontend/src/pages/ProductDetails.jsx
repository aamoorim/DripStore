        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs md:text-sm">
            <div className="bg-[#F9F8FE] border border-gray-100 rounded-xl px-3 py-2">
              ...
              <span className="text-gray-700">Envio em até 2 dias úteis</span>
            </div>
            <div className="bg-[#F9F8FE] border border-gray-100 rounded-xl px-3 py-2">
              <span className="block text-gray-400 font-semibold uppercase text-[0.65rem] tracking-wide">
                Troca garantida
              </span>
              <span className="text-gray-700">30 dias após o recebimento</span>
            </div>
            <div className="bg-[#F9F8FE] border border-gray-100 rounded-xl px-3 py-2">
              <span className="block text-gray-400 font-semibold uppercase text-[0.65rem] tracking-wide">
                Pagamento
              </span>
              <span className="text-gray-700">Até 10x sem juros</span>
            </div>
          </div>
          ...
          <div className="mt-2 flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex-1 bg-primary hover:bg-[#991957] active:bg-[#801447] text-white font-bold py-3 md:py-4 px-6 rounded-xl shadow-md hover:shadow-lg transition-all uppercase text-xs md:text-sm cursor-pointer text-center"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-none sm:w-44 border border-primary/30 text-primary font-semibold py-3 md:py-4 px-6 rounded-xl hover:bg-[#FDF1F8] active:bg-[#FAD7EC] text-xs md:text-sm cursor-pointer transition-colors text-center"
            >
              Comprar agora
            </button>
          </div>
